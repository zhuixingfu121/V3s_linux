-Wp,-MD,arch/arm/boot/compressed/.string.o.d
-nostdinc
-isystem
...
-Os
-DKBUILD_BASENAME=\string' -DKBUILD_MODNAME='string' -c -o arch/arm/boot/compressed/string.o arch/arm/boot/compressed/string.c
